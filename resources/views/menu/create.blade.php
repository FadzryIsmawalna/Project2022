            ...
            <div class="card card-body">
                <form action="/menu" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        <input value="{{ old('price') }}" name="price" type="number" placeholder="Harga" class="form-control" id="floatingInput">
                    </div>
                    <div class="input-group">
                        <button class="btn btn-success rounded me-1" type="submit">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
